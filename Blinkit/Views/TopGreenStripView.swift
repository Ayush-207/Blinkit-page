...
class TopGreenStripView: UIView {
    ...
    private func setupUI(categoryImage: UIImage = UIImage(), text: String = "", icon: UIImage = UIImage()) {
        ...
        NSLayoutConstraint.activate([
            ...
            categoryBackgroundImageView.topAnchor.constraint(equalTo: self.topAnchor, constant: 20),
            ...
            textLabel.topAnchor.constraint(equalTo: categoryBackgroundImageView.bottomAnchor, constant: 10),
            ...
            scrollIconView.topAnchor.constraint(equalTo: textLabel.bottomAnchor, constant: 10),
